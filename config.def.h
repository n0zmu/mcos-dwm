...
static const char *fonts[]          = { "monospace:size=11", "Hack Nerd Font Mono:pixelsize=18:antialias=true" };
static const char dmenufont[]       = "monospace:size=11";
static const char col_gray1[]       = "#222222";
static const char col_gray2[]       = "#444444";
static const char col_gray4[]       = "#bbbbbb";
static const char col_yellow[]      = "#feff86";
...
static const char *dmenucmd[] = { "dmenu_run", "-p", "Run:", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray4, "-sb", col_yellow, "-sf", col_gray1, NULL };
static const char *termcmd[]  = { "st", NULL };
static const char *brwscmd[]  = { "chromium", NULL };
...
static Key keys[] = {
	...
	TAGKEYS(                        XK_ccedilla,               3)
	TAGKEYS(                        XK_agrave,                 4)
	TAGKEYS(                        XK_minus,                  5)
	TAGKEYS(                        XK_egrave,                 6)
	TAGKEYS(                        XK_underscore,             7)
	TAGKEYS(                        XK_apostrophe,             8)
