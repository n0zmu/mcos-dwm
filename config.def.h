...
static const char col_gray2[]       = "#FC5185";
static const char col_gray3[]       = "#A1EAFB";
...
/* commands */
static const char *dmenucmd[] = { "dmenu_run", "-p", "Run:", "-fn", dmenufont, "-nb", col_gray1, "-nf", col_cyan, "-sb", col_gray3, "-sf", col_gray1, NULL };
